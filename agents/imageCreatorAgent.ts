...
import { imageCreateTool, imageDownloadTool } from "../tools";
...
export const imageCreatorAgent = new Agent({
  ...
  2. Create a detailed, vivid prompt for DALL-E image generation
  ...
  model: "gpt-4o",
  tools: [imageCreateTool, imageDownloadTool],
});
